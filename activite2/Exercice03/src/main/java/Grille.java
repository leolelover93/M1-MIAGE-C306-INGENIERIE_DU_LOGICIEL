/**
 * Cette Interface "Grille" permettant de
 * modeliser une grille de Sudoku
 * (de 9x9 ou 16x16).
 */
...
public interface Grille {
  ...
  /**
   * Methode permettant de retourner la dimession
   ...
   * par rapport a ce qu'elle contient deja.
   *
   * @param x position x dans la grille
   * @param y position y dans la grille
   * @param value valeur a mettre dans la case
   * @return vrai si l'action est possible et faux sinon
   * @throws IllegalArgumentException si x ou y sont hors bornes (0-8)
   * @throws IllegalArgumentException si value n'est pas un caractere autorise
   *        ('1',...,'9',..)
   */
